...
export function AuthShell({
  ...
  return (
    <div className="relative min-h-dvh w-full overflow-hidden bg-foreground text-background">
      ...
      <div className="mx-auto flex min-h-dvh max-w-md flex-col gap-6 px-6 pb-12 pt-20">
        ...
        <div>
          ...
          <p className="mt-3 max-w-[280px] text-sm leading-snug text-background/60">
        ...
        <p className="mt-auto pt-6 text-center text-[11px] text-background/40">
...
export const authInputClass =
  "w-full rounded-xl border border-[#2A332E] bg-[#1B231D] px-4 py-3.5 text-[15px] text-background outline-none transition-colors placeholder:text-background/40 focus:border-accent/60";
...
export const authGhostBtnClass =
  "flex w-full items-center justify-center gap-2 rounded-xl border border-[#2A332E] bg-transparent px-4 py-3 text-sm font-bold text-background transition hover:bg-white/[0.04] active:scale-[0.99] disabled:opacity-60";
